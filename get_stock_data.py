...
df = df.reset_index(level=0) #convert date from index field to normal column
...
# get stock info
tickobj = yf.Ticker(symbol)
tickname = tickobj.info["shortName"]


ax,ax2 = fplt.create_plot(tickname, rows=2)
